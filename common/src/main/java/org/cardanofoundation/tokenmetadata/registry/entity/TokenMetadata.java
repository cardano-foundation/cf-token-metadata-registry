...
public class TokenMetadata {
    ...
    /**
     * CIP-26 {@code policy} field: base16 CBOR-encoded phase-1 monetary script (a native
     * script), <strong>not</strong> the 28-byte policyId hash (that lives in the first
     * 56 hex chars of {@link #subject}). Clients verify an entry by re-hashing this field
     * through blake2b-224 and comparing to the first 28 bytes of {@code subject}.
     * <p>
     ...
     * {@code length} attribute here. The widening is performed by migration
     * {@code V5__widen_metadata_policy_to_text.sql}.
     *
