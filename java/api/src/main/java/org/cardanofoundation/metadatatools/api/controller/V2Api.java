...
public interface V2Api {
     ...
     * or If the subject is not present in the metadata server. (status code 404)
     */
    @Operation(operationId = "getSubjectV2", summary = "Query all properties or specified properties of the given subject", responses = {@ApiResponse(responseCode = "200", description = "The metadata related to the queried subject.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Property.class))), @ApiResponse(responseCode = "204", description = "If the subject is present in the metadata server but has not data for the given fields list."), @ApiResponse(responseCode = "404", description = "If the subject is not present in the metadata server.")})
    @RequestMapping(method = RequestMethod.GET, value = "/v2/subjects/{subject}", produces = {"application/json;charset=utf-8"})
    default ResponseEntity<Property> getSubjectV2(@Parameter(name = "subject", description = "", required = true, schema = @Schema(description = "")) @PathVariable("subject") final String subject, @Parameter(name = "fields", description = "", schema = @Schema(description = "")) @Valid @RequestParam(value = "fields", required = false) final String fields) {
     ...
     */
    @Operation(operationId = "postSubjectV2", summary = "Post a new token metadata submission.", responses = {@ApiResponse(responseCode = "200", description = "Returns the complete metadata after a successfull request.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Property.class))), @ApiResponse(responseCode = "400", description = "Returned if validation of the given metadata object failed.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = VerifyFailureResponse.class)))})
    ...
    default ResponseEntity<Property> postSubjectV2(@Parameter(name = "subject", description = "", required = true, schema = @Schema(description = "")) @PathVariable("subject") final String subject, @Parameter(name = "Property", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestBody final Property property) {
     ...
     * or Returned if validation of the given metadata object failed. (status code 400)
     */
    @Operation(operationId = "postSignaturesV2", summary = "Post signatures for properties of a subject.", responses = {@ApiResponse(responseCode = "200", description = "Returns the complete metadata after a successful request.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Property.class))), @ApiResponse(responseCode = "400", description = "Returned if validation of the given metadata object failed.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = VerifyFailureResponse.class)))})
    @RequestMapping(method = RequestMethod.POST, value = "/v2/subjects/{subject}", produces = {"application/json;charset=utf-8"}, consumes = {"application/json;charset=utf-8"})
    default ResponseEntity<Property> postSignaturesV2(
            @Parameter(name = "subject", description = "", required = true, schema = @Schema(description = "")) @PathVariable("subject") final String subject,
            @Parameter(name = "signatures", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestBody final Property property) {
        return getDelegate().postSubjectV2(subject, property);
    }
    ...
    default ResponseEntity<WalletTrustCheckResponse> v2ForensicsWallet(@Parameter(name = "addresshash", description = "", required = true, schema = @Schema(description = "")) @PathVariable("addresshash") final String addresshash) {
    ...
    default ResponseEntity<WalletTrustCheckResponse> v2ForensicsWallets(@Parameter(name = "WalletHashes", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestBody final WalletHashes walletHashes) {
    ...
    default ResponseEntity<Void> verifySubjectV2(@Parameter(name = "subject", description = "", required = true, schema = @Schema(description = "")) @PathVariable("subject") final String subject, @Parameter(name = "Property", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestBody final Property property) {
