...
public interface V2Api {
  ...
  ResponseEntity<SubjectsResponse> getSubjectsV2(
      ...
      @Parameter(name = "fields", description = "", schema = @Schema(description = ""))
          ...
          @RequestParam(value = "fields", required = false)
          final String fields,
      @Parameter(name = "sort_by", description = "", schema = @Schema(description = ""))
          @Valid
      ...
      @Parameter(
          ...
          @Valid
          @RequestParam(value = "name_op", required = false)
          final FilterOperand nameOp,
      @Parameter(name = "ticker", description = "", schema = @Schema(description = ""))
          @Valid
      ...
      @Parameter(
              ...
              schema =
                  @Schema(
                      ...
                      allowableValues = {"eq", "neq", "lt", "lte", "gt", "gte"}))
          @Valid
          @RequestParam(value = "ticker_op", required = false)
          final FilterOperand tickerOp,
      @Parameter(name = "description", description = "", schema = @Schema(description = ""))
          @Valid
      ...
      @Parameter(
              ...
              schema =
                  @Schema(
                      ...
                      allowableValues = {"eq", "neq", "lt", "lte", "gt", "gte"}))
          @Valid
          @RequestParam(value = "description_op", required = false)
          final FilterOperand descriptionOp,
      @Parameter(name = "url", description = "", schema = @Schema(description = ""))
          @Valid
      ...
      @Parameter(
              ...
              schema =
                  @Schema(
                      ...
                      allowableValues = {"eq", "neq", "lt", "lte", "gt", "gte"}))
          @Valid
          @RequestParam(value = "url_op", required = false)
          final FilterOperand urlOp,
      @Parameter(name = "policy", description = "", schema = @Schema(description = ""))
          @Valid
      ...
      @Parameter(
              ...
              schema =
                  @Schema(
                      ...
                      allowableValues = {"eq", "neq", "lt", "lte", "gt", "gte"}))
          @Valid
          @RequestParam(value = "policy_op", required = false)
          final FilterOperand policyOp,
      @Parameter(name = "updated", description = "", schema = @Schema(description = ""))
          @Valid
      ...
      @Parameter(
              ...
              schema =
                  @Schema(
                      ...
                      allowableValues = {"eq", "neq", "lt", "lte", "gt", "gte"}))
          @Valid
          @RequestParam(value = "updated_op", required = false)
          final FilterOperand updatedOp,
      @Parameter(name = "updated_by", description = "", schema = @Schema(description = ""))
          @Valid
          @RequestParam(value = "updated_by", required = false)
      ...
      @Parameter(
              ...
              schema =
                  @Schema(
                      ...
                      allowableValues = {"eq", "neq", "lt", "lte", "gt", "gte"}))
          @Valid
          @RequestParam(value = "updatedby_op", required = false)
          final FilterOperand updatedbyOp,
      @Parameter(name = "decimals", description = "", schema = @Schema(description = ""))
          @Valid
          @RequestParam(value = "decimals", required = false)
      ...
      @Parameter(
              ...
              schema =
                  @Schema(
                      ...
                      allowableValues = {"eq", "neq", "lt", "lte", "gt", "gte"}))
          @Valid
          @RequestParam(value = "decimals_op", required = false)
      ...
      @Parameter(
              ...
              schema = @Schema(description = ""))
          @Valid
          @RequestParam(value = "vkey", required = false)
          final String vkey,
      @Min(1)
          @Max(200)
          @Parameter(
      ...
      @Parameter(
              ...
              schema = @Schema(description = ""))
          @Valid
          @RequestParam(value = "pivot_id", required = false)
