...
public interface MetadataApi {
    ...
    @GetMapping(value = "/metadata/{subject}/properties/{property}", produces = {"application/json;charset=utf-8"})
    ...
    @PostMapping(value = "/metadata/query", produces = {"application/json;charset=utf-8"}, consumes = {"application/json;charset=utf-8"})
