...
public interface V2Api {
    ...
    ResponseEntity<SubjectsResponse> getSubjectsV2(
            ...
            @Parameter(name = "page", description = "The page that shall be displayed, meaning results are limited using a clause like `limit page offset (page)*limit`", schema = @Schema(description = "")) @Valid @RequestParam(value = "page", required = false) final Long page,
            @Parameter(name = "pivot_id", description = "Used for pagination. Only records before or after the given pivot element will be returned.", schema = @Schema(description = "")) @Valid @RequestParam(value = "pivot_id", required = false) final String pivotId, @Parameter(name = "pivot_direction", description = "Used for pagination. Specified if elements before or after the pivotId will be returned.", schema = @Schema(description = "")) @Valid @RequestParam(value = "pivot_direction", required = false) final PivotDirection pivotDirection,
            @Parameter(name = "network", description = "Specify the network from which metadata is requested. This must be mapped to a data source in the application properties.", required = false, schema = @Schema(description = "")) @Valid @RequestParam(value = "network", required = false, defaultValue = "mainnet") final String network);
    ...
    ResponseEntity<TokenMetadata> postSubjectV2(
            @Parameter(name = "subject", description = "", required = true, schema = @Schema(description = "")) @PathVariable("subject") final String subject,
            @Parameter(name = "Property", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestBody final TokenMetadata property,
            @Parameter(name = "network", description = "Specify the network from which metadata is requested. This must be mapped to a data source in the application properties.", required = false, schema = @Schema(description = "")) @Valid @RequestParam(value = "network", required = false, defaultValue = "mainnet") final String network);
    ...
    ResponseEntity<Void> verifySubjectV2(
            @Parameter(name = "subject", description = "", required = true, schema = @Schema(description = "")) @PathVariable("subject") final String subject,
            @Parameter(name = "Property", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestBody final TokenMetadata tokenMetadata,
            @Parameter(name = "network", description = "Specify the network from which metadata is requested. This must be mapped to a data source in the application properties.", required = false, schema = @Schema(description = "")) @Valid @RequestParam(value = "network", required = false, defaultValue = "mainnet") final String network);
    ...
    ResponseEntity<WalletTrustCheckResponse> v2ForensicsWallet(
            @Parameter(name = "addresshash", description = "", required = true, schema = @Schema(description = "")) @PathVariable("addresshash") final String walletAddressHash);
    ...
    ResponseEntity<WalletTrustCheckResponse> v2ForensicsWallets(
            @Parameter(name = "WalletHashes", description = "", required = true, schema = @Schema(description = "")) @Valid @RequestBody final WalletHashes walletAddressHashes);
}
