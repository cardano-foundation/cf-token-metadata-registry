...
public class MetadataApiV2IntegrationTest {
    ...
    void setUp() {
        ...
        when(v1ApiMetadataIndexer.findSubject("025146866af908340247fe4e9672d5ac7059f1e8534696b5f920c9e66362544848")).
                thenReturn(Optional.of(TokenMetadata.builder().subject("025146866af908340247fe4e9672d5ac7059f1e8534696b5f920c9e66362544848")
                        .url(urlProperty).build()));

        when(v1ApiMetadataIndexer.findSubjectSelectProperties("025146866af908340247fe4e9672d5ac7059f1e8534696b5f920c9e66362544848",
                List.of("url"))).thenReturn(Optional.of(TokenMetadata.builder().subject("025146866af908340247fe4e9672d5ac7059f1e8534696b5f920c9e66362544848").url(urlProperty).build()));
    }

    @Test
    public void subjectQueryShouldReturnNoContentOnNonExistingSubject() throws Exception {
        mockMvc.perform(get("/v2/subjects/025146866af908340247fe4e9672d5ac7059f1e8534696b5f920c9e66362544843"))
    ...
    public void subjectQueryShouldReturnMetadata() throws Exception {
        mockMvc.perform(get("/v2/subjects/025146866af908340247fe4e9672d5ac7059f1e8534696b5f920c9e66362544848"))
                .andExpect(status().isOk()).andExpect(MockMvcResultMatchers.jsonPath("$.subject")
    ...
    public void subjectPropertyQueryShouldReturnMetadata() throws Exception {
        mockMvc.perform(get("/v2/subjects/025146866af908340247fe4e9672d5ac7059f1e8534696b5f920c9e66362544848")
                .param("fields", "url")).andExpect(status().isOk()).andExpect(MockMvcResultMatchers
                .jsonPath("$.subject").value("025146866af908340247fe4e9672d5ac7059f1e8534696b5f920c9e66362544848"));
    }
}
