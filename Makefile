push: 
	...
	aws ecs execute-command --cluster "dev-cf-metadata-tools" --task d60199ec0541468f8e40fe99413ae098 --container server --interactive --command "bash" --profile AdministratorAccess